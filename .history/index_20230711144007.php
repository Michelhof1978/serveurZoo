...
Par exemple, si `$_GET['page']` contient une URL avec des caractères spéciaux ou des caractères non
 valides, l'utilisation de `filter_var($_GET['page'], FILTER_SANITIZE_URL)` permettra de nettoyer cette valeur et de ne conserver que les caractères valides pour une URL.
