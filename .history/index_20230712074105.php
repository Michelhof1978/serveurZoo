                ...
                switch($url[1]){//On va vérifier la valeur du 2 ème champs (position 1 ds tableau) après le / ds l url
                   ...
                   case "animaux":
                    ...
                    if (!isset($url[2]) || !isset($url[3])) {
                        ...
                        $apiController->getAnimaux(-1, -1);//Comme modification ds ma requête, On récupèrera les infos famille -1 et continent -1 dans API.controller.php grâce à la fonction getAnimaux
                    } else {
