...
class APIManager extends Model{//Système d héritage avec extends
    public function getDBAnimaux(){//L'utilisation du modificateur public permet de rendre la 
        méthode accessible et utilisable de manière externe à la classe, ce qui est souvent nécessaire pour interagir avec les objets de cette classe dans d'autres parties du code.
    //   -------------------------
