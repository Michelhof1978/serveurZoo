...
class APIManager extends Model{//Système d héritage avec extends
    public function getDBAnimaux($idFamille, $idContinent){//L'utilisation du modificateur public permet de rendre la 
            ...
            $whereClause = "";//On la concaténera ds la requête $req ci-dessous avec la table continent.Elle devra contiendra le mot WHERE seulement si on a -1 ds les 2 champs idFamille et idContinent
