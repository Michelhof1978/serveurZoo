...
public function getDBAnimal($idAnimal){
    ...
    inner join animal_continent ac on ac.animal_id = a.animal_id 
    inner join continent c on c.continent_id = ac.continent_id";
    WHERE a.animal_id = :idAnimal;// Système de filtrage avec WHERE, on récupèrera uniquepment la valeur choiszi ds la table animal: exemple, si un client veut du pain
