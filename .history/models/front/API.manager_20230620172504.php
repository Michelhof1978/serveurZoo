...
class APIManager extends Model{//Système d héritage avec extends
    public function getDBAnimaux(){
      ...
      En résumé, cette requête sélectionne toutes les colonnes de la table "animal" et effectue des
       jointures avec les tables "famille", "animal_continent" et "continent" en utilisant les clés étrangères appropriées. Cela permet d'obtenir les informations liées aux animaux, à leur famille et aux continents auxquels ils appartiennent.
