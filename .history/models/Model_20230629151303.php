    ...
    public static function sendJSON($info){//Transformer les datas en format JSON pour API
        ...
        header("content-Type: application/json");
                         ...
                         terme :
                             ...
                             fournissent des informations supplémentaires sur la réponse que le serveur envoie au client. Dans ce cas, la fonction "header" est utilisée pour définir l'en-tête "Content-Type".
