...
abstract class Model {//En héritant de la classe abstraite "Model", les classes enfants peuvent étendre ou modifier le comportement de base défini dans la classe parente, en ajoutant des méthodes spécifiques à leurs besoins ou en redéfinissant des méthodes existantes.

    L'utilisation d'une classe abstraite permet de centraliser la logique commune liée à la manipulation des données dans une seule classe, ce qui facilite la maintenance, la réutilisation du code et favorise une meilleure structure de l'application.
    private static $pdo;
