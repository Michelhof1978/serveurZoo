...
La fonction "formatDataLignesAnimaux" est une méthode privée qui prend en paramètre un tableau de lignes de données. Elle formate ces données dans une structure spécifique et renvoie un nouveau tableau.
