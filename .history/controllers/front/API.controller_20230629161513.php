...
Voici une explication du fonctionnement de cette méthode :- Au départ, un tableau vide est créé avec la variable "$tab". Ce tableau sera utilisé pour stocker les données formatées.
