...
//   pouvez vous assurer que cette ressource est disponible dès la création de chaque objet de la classe.
    ...
    public function getAnimaux($idFamille, $idContinent){//FILTRE SERVEUR
        $animaux = $this->apiManager->getDBAnimaux($idAnimal, $idContinent);//on crée une nouvelle variable animaux pour récupérer toutes les datas de la BDD des animaux que le manager s'occupera de récupérer
