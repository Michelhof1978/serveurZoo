...
public function getAnimal($idAnimal){
    //Pour info,L'id animal sera mis en 2 ème position ds l'url
   $lignesAnimal = $this->apiManager->getDBAnima($idAnimal);
   echo "<pre>";//pour formater et afficher les données de sortie de manière lisible.
   print_r($lignesAnimal);//http://localhost/serveurzoo/front/animal  = affichage de la liste des animaux sous forme de tableau
   echo "</pre>";
}
