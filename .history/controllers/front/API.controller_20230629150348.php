...
public function getAnimal($idAnimal){
    ...
    public function getFamilles(){
        ...
        Model::sendJSON($familles);//On appel la fonction sendJson de la classe Model et on appel familles qui est le résultat de la requête et le transformera en format JSAON
        // echo "<pre>";
        // print_r($familles);
        // echo "</pre>";
    }
