            ...
            case "front" : ;//http://localhost:8000/serveuranimaux/front/test
                switch($url[1]){//On va vérifier la valeur du 2 ème champs (position 1 ds tableau) après le / ds l url
                   ...
                   case "animaux":
                    ...
                    //........................................................................
                    if $idFamille = (!isset($url[2]) || !isset($url[3])) {
                        ...
                        $idContinent = $apiController->getAnimaux((int)$url[2], (int)$url[3]); // Les URL sont automatiquement en string, donc ici, on va les convertir en int
                    }
                    break;
                //............................................................................
